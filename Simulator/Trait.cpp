...
{
	conditionBlock = scripting::ConditionBlock(scripting::ConditionBlock::AnyScope::ConditionOpcode::CHARECTER_SCOPE);
...
{
	scripting::ConditionBlock block(scripting::ConditionBlock::AnyScope::ConditionOpcode::CHARECTER_SCOPE);
...
void Trait::init_field_setters()
{
	field_setters =
	{
		...
		{"male_insult_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::MALE, Trait::Greeting::Type::INSULT);}},
		{"female_insult_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::FEMALE, Trait::Greeting::Type::INSULT);}},
		{"child_insult_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::CHILD, Trait::Greeting::Type::INSULT);}},
		{"male_compliment_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::MALE, Trait::Greeting::Type::COMPLIMENT);}},
		{"female_compliment_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::FEMALE, Trait::Greeting::Type::COMPLIMENT);}},
		{"child_compliment_adj", [](Trait& trait, const Node& node){return trait.set_greeting_adjective(node, Trait::Greeting::Target::CHILD, Trait::Greeting::Type::COMPLIMENT);}},

		{"male_insult", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::MALE, Trait::Greeting::Type::INSULT);}},
		{"female_insult", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::FEMALE, Trait::Greeting::Type::INSULT);}},
		{"child_insult", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::CHILD, Trait::Greeting::Type::INSULT);}},
		{"male_compliment", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::MALE, Trait::Greeting::Type::COMPLIMENT);}},
		{"female_compliment", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::FEMALE, Trait::Greeting::Type::COMPLIMENT);}},
		{"child_compliment", [](Trait& trait, const Node& node){return trait.set_greeting(node, Trait::Greeting::Target::CHILD, Trait::Greeting::Type::COMPLIMENT);}},
